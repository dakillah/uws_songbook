...
function handleSongChangeEvent(event) {
    ...
    const httpQuery = "https://uws-songbook-svr.onrender.com/listDistinctArtistsTest?title=" + songTitle;
...
function handleArtistChangeEvent(event) {
    ...
    const xhr = new XMLHttpRequest();
    const httpQuery = "https://uws-songbook-svr.onrender.com/listDistinctTitlesTest?artist=" + artist;
    xhr.open('GET', httpQuery); // Replace with your API endpoint
...
function retrieveAndDisplaySong(){
    ...
    const xhr = new XMLHttpRequest();
    const httpQuery = "https://uws-songbook-svr.onrender.com/getLyricsTest?artist=" + songArtist + "&title=" + songTitle;
    xhr.open('GET', httpQuery); // Replace with your API endpoint
...
function initSongSelection() {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('GET', 'https://uws-songbook-svr.onrender.com/listTitlesTest'); // Replace with your API endpoint
...
function initArtistSelection() {
    ...
    const xhr = new XMLHttpRequest();
    xhr.open('GET', 'https://uws-songbook-svr.onrender.com/listArtistsTest'); // Replace with your API endpoint
